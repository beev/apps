...
path: stopping/following-distance
order: 1
parent: stopping
lastmod: 2016-06-20
legacy_url: emergencystop/distance
---

The minimum safe following distance is around two seconds behind the vehicle in front. A good way to measure this is to watch the vehicle in front of you as it passes a fixed object such as a bridge, a tree, or a road sign. At least two seconds should have elapsed before you vehicle passes the same object. To measure two seconds, you can say to yourself: "Only a fool breaks the two second rule." Don't say it too fast!
