---
title: Space And Speed
path: position/space-and-speed
order: 3
parent: position
lastmod: 2016-06-20
legacy_url: position/spaceandspeed
---
...
![Four cars parked nose to tail along the left of a road. A blue car travelling up the road meets a red car coming the other way, its path marked by an arrow, and the parked cars leave only a narrow gap for the two to pass.](narrowed-gap-parked-cars.webp)
